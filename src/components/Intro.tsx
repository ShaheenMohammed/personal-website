function Intro() {
  return (
    <div className="flex flex-col justify center place-items-center font-editorial text-white">
        ...
        <div className="flex justify-center italic tracking-tight text-xs px-2 pt-4 pb-8 gap-4 md:pt-8 md:pb-10 md:gap-13 md:text-2xl xl:pt-15 xl:pb-20 xl:text-4xl xl:gap-30 2xl:gap-40 2xl:text-6xl 2xl:pb-30">
