...
function Header() {
  return (
    <header className = "mx-auto w-full text-white">
      <section className="flex justify-center text-center xl:pt-10 2xl:pt-20">
        <div className="flex justify-center place-items-center font-extralight pt-8 gap-4 text-xs md:gap-6 md:pt-9 md:text-sm xl:text-lg xl:pt-10 xl:gap-8 2xl:text-xl 2xl:gap-8">
